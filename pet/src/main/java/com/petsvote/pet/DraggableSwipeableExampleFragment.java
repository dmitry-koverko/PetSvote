...
import com.petsvote.pet.adapter.AbstractDataProvider;
import com.petsvote.pet.adapter.DraggableSwipeableExampleAdapter;
import com.petsvote.pet.data.ExampleDataProvider;
...
public class DraggableSwipeableExampleFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerViewDragDropManager.setDraggingItemShadowDrawable(
                (NinePatchDrawable) ContextCompat.getDrawable(requireContext(), R.drawable.ic_back_m));
        ...
        if (supportsViewElevation()) {
            ...
            mRecyclerView.addItemDecoration(new ItemShadowDecorator((NinePatchDrawable) ContextCompat.getDrawable(requireContext(), R.drawable.ic_google)));
        }
